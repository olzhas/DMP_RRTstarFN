...
double rpy[][3] = {{ 0, 0, 0},
                   ...
                   { 0, 0, 1.7},
                   { 0, 0, 0.7},
                   { 6.16858072, 3.14151269, 2.59488083},
...
double pos[][3] = {{ 0.1, 0.55, 1.25},
                   { -0.56, 0.55, 1.25},
                   { -0.35062380602, -10.12386489, 0.94},
                   { 1.1928936962, 2.50127804174, 0.94},
                   { -0.91550389221, -0.517130716, 1.2319404208},
                   { 0.768004659, -0.28275033, 1.62313115908},
                   {0.2, -0.7,1.45}};
}
