...
if (circle == 1) {
	#set object 2 circle at 0.8,1.0 size .1 fc rgb "#FF4444"
	set object 2 circle at 0.9,1.0 size .1 fc rgb "#FF4444"
}
if (circle == 2) {
	#set object 3 circle at 0.799238939618349,1.01743114854953 size .1 fc rgb "#2244FF"
	set object 3 circle at 0.9518,1.1932 size .1 fc rgb "#2244FF"
}
if (circle == 3) {
...
if (exists("filenameResultsMilestones") && file_exists(filenameResultsMilestones)) {
	plot filenameResultsMilestones using 1:2 notitle lc rgb "#FFAA11" pointtype 9 pointsize 5 lw 5
}
