...
if (circle == 1) {
	...
	set object 2 circle at 0.9,0.50 size .1 fc rgb "#22FF4444" front
}
if (circle == 2) {
	...
	#
	#set object 3 circle at 1.05,1.4 size .1 fs solid fc rgb "#222244FF" front 
}
if (circle == 3) {
	...
	set object 2 circle at 0.9,0.50 size .1 fs solid fc rgb "#22FF4444" front
	#set object 3 circle at 1.05,1.4 size .1 fs solid fc rgb "#222244FF" front 
	###set object 3 circle at 0.9,1.2 size .1 fs solid fc rgb "#222244FF" front 
